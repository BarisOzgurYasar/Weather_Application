...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Map getForecastWeather(int index) {
      String maxWindSpeed = weatherData[index]["day"]["maxwind_kph"].toString();
      String avgHumidity = weatherData[index]["day"]["avghumidity"].toString();
      String chanceOfRain =
          weatherData[index]["day"]["daily_chance_of_rain"].toString();

      var paredDate = DateTime.parse(weatherData[index]["date"]);
      var forecastDate = DateFormat('EEEE, d MMMM').format(paredDate);

      String weatherName = weatherData[index]["day"]["condition"]["text"];
      String weatherIcon =
          weatherName.replaceAll(' ', ' ').toLowerCase() + '.png';

      String minTemperature = weatherData[index]["day"]["min_temp_c"].toString();
      String maxTemperature = weatherData[index]["day"]["max_temp_c"].toString();

      var forecastData = {
        'maxWindSpeed': '0',// maxWindSpeed,
        'avgHumidity': '0',//avgHumidity,
        'chanceOfRain': '0', // chanceOfRain,
        'forecastDate': '0', //forecastDate,
        'weatherName': '0', //weatherName,
